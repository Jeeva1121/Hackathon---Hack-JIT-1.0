...
const RegistrationForm: React.FC = () => {
    ...
    const hackathonRules = [
        ...
        "The hackathon will run for 24 hours (Feb 6, 10 AM - Feb 7, 10 AM).",
        "Submissions after 10:00 AM will not be accepted.",
        ...
        "Coding and development must begin only after 10:00 AM.",
